...
# Keep the robbyrussell prompt without Git branch/status information.
...
# Custom shell setup restored from ~/.zshrc.pre-oh-my-zsh.

# Avoid duplicated PATH entries as installers prepend their own directories.
typeset -U path PATH
